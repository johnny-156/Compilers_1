...
%{
	...
	private static Logger log = Logger.getLogger(Yylex.class);
...
(0|[1-9][0-9]*)	{return new_symbol(sym.NUMBER, Integer.valueOf(yytext()));}
([a-z]|[A-Z])[a-z|A-Z|0-9|_]*	{return new_symbol(sym.IDENT, yytext());}
"'" . "'" 						{return new_symbol(sym.CHAR, yytext());}


. {log.error("Leksicka greska ("+yytext()+") u liniji " + (yyline+1) +  " (at column " + yycolumn + ")");}