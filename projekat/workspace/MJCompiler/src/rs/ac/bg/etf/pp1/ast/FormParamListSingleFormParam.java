...
public class FormParamListSingleFormParam extends FormalParamList {

    private FormalParamDecl FormalParamDecl;

    public FormParamListSingleFormParam (FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormParamListSingleFormParam(\n");
