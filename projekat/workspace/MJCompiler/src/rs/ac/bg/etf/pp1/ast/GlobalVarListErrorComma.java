...
public class GlobalVarListErrorComma extends GlobalVarList {

    private GlobalVarList GlobalVarList;
    private GlobalVarOption GlobalVarOption;

    public GlobalVarListErrorComma (GlobalVarList GlobalVarList, GlobalVarOption GlobalVarOption) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalVarListErrorComma(\n");
