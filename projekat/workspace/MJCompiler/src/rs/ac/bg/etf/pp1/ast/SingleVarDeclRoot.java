...
public class SingleVarDeclRoot extends VarDeclRoot {

    private GlobalVarType GlobalVarType;
    private VarDeclList VarDeclList;

    public SingleVarDeclRoot (GlobalVarType GlobalVarType, VarDeclList VarDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleVarDeclRoot(\n");
