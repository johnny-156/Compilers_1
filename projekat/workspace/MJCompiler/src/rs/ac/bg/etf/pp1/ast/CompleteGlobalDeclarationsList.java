...
public class CompleteGlobalDeclarationsList extends GlobalDeclarations {

    private MultipleDeclarationsList MultipleDeclarationsList;

    public CompleteGlobalDeclarationsList (MultipleDeclarationsList MultipleDeclarationsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CompleteGlobalDeclarationsList(\n");
