...
public class ConstDeclListErrorComma extends ConstDeclList {

    private ConstDeclList ConstDeclList;
    private ConstDeclOption ConstDeclOption;

    public ConstDeclListErrorComma (ConstDeclList ConstDeclList, ConstDeclOption ConstDeclOption) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstDeclListErrorComma(\n");
